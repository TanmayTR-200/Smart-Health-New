...
function PHCDetail() {
  ...
  const loadData = async () => {
    try {
      const [phcRes, stockRes, footfallRes, bedsRes, attendanceRes] = await Promise.all([
        getPHC(id),
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 gap-5 mb-8">
        ...
        <div className="glass-card rounded-2xl p-6">
          <h2 className="text-lg font-bold text-slate-800 mb-5">{t('patientFootfall')}</h2>
      ...
      {/* Stock Details */}
      <div className="glass-card rounded-2xl p-6">
        <h2 className="text-lg font-bold text-slate-800 mb-5">{t('currentStockLevels')}</h2>
